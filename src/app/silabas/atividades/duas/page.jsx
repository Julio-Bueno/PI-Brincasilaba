...
const fases = [
    {palavra: 'PATO', silabas: ["PA","TO", "CA", "SA"]},
    {palavra: 'SAPO', silabas: ["SA","PO", "JA", "CA"]},
    {palavra: 'CASA', silabas: ["CA","SA", "LA", "MA"]},
    {palavra: "GATO", silabas: ["GA", "TO", "TA", "GO", "CA"] },
    {palavra: "BOLA", silabas: ["BO", "LA", "LO", "BA", "LE"] },
]

export default function Dissilaba(){
    ...
    function selecionarSilaba(s){
        if(selecionada.length >= 2) return;
        setFeedback("");
